...
require("dotenv").config(); // throws console error 
const keys = require("./keys");
const Spotify = require("node-spotify-api");
const spotify = new Spotify(keys.spotify); // throws console error (not defined)
...
function userCommand(userInput, userQuery) {
    switch (userInput) {
        // able to fire URL request below but not with "movie-this" command
        case "movie-this":
            movieThis();
            break;
        case "concert-this":
